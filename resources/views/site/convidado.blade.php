...
float: right;
font-size: 16px;"> {{date('d/m/y')}}  &nbsp; <a href="#" class="btn btn-danger square-btn-adjust">Logout</a></div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="ui.html"><i class="fa fa-file fa-3x"></i> Registos</a>
                    </li>
                    <li>
                        <a  href="tab-panel.html"><i class="fa fa-user fa-3x"></i> Utentes</a>
                    </li>
						   <li  >
                        <a   href="chart.html"><i class="fa fa-bar-chart-o fa-3x"></i> Funcionarios</a>
                    </li>	
                      <li  >
                        <a  href="table.html"><i class="fa fa-table fa-3x"></i> Notificacao</a>
                    </li>
                    <li  >
