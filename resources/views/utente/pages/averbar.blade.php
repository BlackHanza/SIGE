...
<div class="container">
  <div class="py-5 text-center">
      <h2 class="mt-1">Averbar Bilhete</h2>
  </div>
  <div class="row">
...
@csrf
        ...
        <div class="row">          
          ...
          <div class="col-md-5 mb-3">
            ...
            <input type="text" class="form-control"  placeholder="Número do Bilhete"  required name="bi_numero">
            <div class="invalid-feedback">
         ...
         <div class="row">
          ...
          <div class="col-md-5 mb-3">
            ...
            <select class="custom-select d-block w-100" required name="distrito">
