...
<html>
  <head>
    ...
    <link href="{{ asset('site/daterangepicker.css') }}" rel="stylesheet" type="text/css" />

    <link href="{{ asset('site/bootstrap3-wysihtml5-bower.css') }}" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="" class="logo"><b>Admin</b> SIGE</a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="#"><a href="{{route('AdminRegisto')}}"><i class="fa fa-archive"></i> Todos registos</a></li>
                <li><a href="{{route('aprovados')}}"><i class="fa fa-check"></i> Aprovados</a></li>
                <li><a href="{{route('reprovados')}}"><i class="fa fa-trash-o"></i> Reprovados</a></li>               
              </ul>
            </li> 
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="pages/examples/invoice.html"><i class="fa fa-users-o"></i> Utentes</a></li>
                <li><a href="{{route('funcionario.index')}}"><i class="fa fa-users-o"></i> Funcionários</a></li>
              </ul>
              </li>
            <li class="#">
              <a href="{{route('suporte.index')}}">
                <i class="fa fa-bell"></i><span>Notificação</span>
              </a>              
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2022-2023 <a href="http://almsaeedstudio.com">Kalunga Developers</a>.</strong> All rights reserved.
      </footer>
